...
urlpatterns = [
    ...
    path("super/dashboard/<user_id>/",views.admin_dashboard_view,name="admin_dashboard_view"),
    path("create/group/<user_id>/",views.create_group,name="create_group_view"),
    path("delete/<group_id>/group/",views.admin_delete_group,name="admin_delete_group_view"),
